...
const SearchBar = () => {
  ...
  const  [searchTerm, setSearchTerm] = useState("");
    ...
    return (
   <>
     <div className='DinamicsCarsCities'>
     <div className='searchBar_container'> 
            <input type="text"  placeholder='Let`s search cities...' onChange={(event) =>
            ...
            <div className='template' key={val.id}>
                <h5>Detalles de la ciudad</h5>
                 ...
                 <p>Currency: {val.currency}</p>
                  <p>Tourist spots: {val.tourist_spots}</p>
               <>  
              <Anchor to={"/cities/Itinerary"}>
              <button className='cityDetails_button' onClick={() => {
                      alert("The city details are: " + val.name + " is a city from " + val.country + ". It has a population of " + val.population + "," + "Its currency is " + val.currency + ". " +"We recomend visit" + " " + val.tourist_spots+".");
                  }}>City details</button>
              </Anchor>
              </>
            </div>
...
//             <div className='result_container' ref={resultRef}></div>
//         </div>
